...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddAssemblyIncludingInternals(this IServiceCollection services, Func<string, bool> checkName, ServiceLifetime liveTime, params Assembly[] assemblies)
    {
