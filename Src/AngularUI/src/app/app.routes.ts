...
export const routes: Routes = [
  ...
  { path: 'tournaments/:tournamentId/start', component: TournamentStartComponent, canActivate: [canActivateAuthRole], data: { role: environment.roles.user } },
  { path: 'tournaments/:tournamentId/teams', component: TeamListComponent, canActivate: [canActivateAuthRole], data: { role: environment.roles.user } },
